...
| `docs/06-operations/authoring-mcp-production-rra-request-v0.37.md` | Authoring MCP production activation RRA handoff | Use when asking an admin worker/operator to audit env metadata and activate Authoring MCP without exposing secrets |
