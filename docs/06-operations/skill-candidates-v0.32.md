...
| `authoring-mcp-minimal-adapter-check` | Checks the minimal import/status tool adapter, route rewrite, import schema, idempotency, and deferred-tool guard | `api/authoring-mcp.js`, `api/_lib/authoring-mcp-service.js`, `docs/04-data/authoring-mcp-migration-v0.35.sql`, `reports/authoring-mcp-readiness-v0.35.json` | `skills/dreamlabs-specific/atomic` |
